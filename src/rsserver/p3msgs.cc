...
ChatLobbyId p3Msgs::createChatLobby(const std::string& lobby_name,const RsGxsId& lobby_identity,const std::string& lobby_topic,const std::string& lobby_description, const std::set<RsPeerId>& invited_friends,ChatLobbyFlags privacy_type)
{
    return mChatSrv->createChatLobby(lobby_name,lobby_identity,lobby_topic,lobby_description,invited_friends,privacy_type) ;
}
