...
class DistributedChatService
{
	public:
		...
		ChatLobbyId createChatLobby(const std::string& lobby_name,const RsGxsId& lobby_identity,const std::string& lobby_topic,const std::string& lobby_description,const std::set<RsPeerId>& invited_friends,ChatLobbyFlags flags) ;
